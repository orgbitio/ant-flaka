 ...
 * * </code> Executing this command would issue a warning like * * <code>
 * * Overriding previous definition of type javac
 * * </code> Unfortunatly there is no easy way to remove such warnings. Looking
 * * how this is implemented, it appears that method * * <code>
 * * ComponentHelper.updateDataTypeDefinition()
 * * </code> is the guilty part. It is rather easy to exchange this faulty *
  ...
  private void updateDataTypeDefinition(AntTypeDefinition def) {
    ...
    synchronized (antTypeTable) {
      ...
      if (old != null) {
        ...
        boolean isTask = (oldClass != null && Task.class
            .isAssignableFrom(oldClass));
