...
public class Break extends Task {
  ...
  public void execute() throws BuildException {
    ...
    // did *not* work out: Ant will wrap any exception not having a message
    // or
    ...
    // The current implementation inserts a special character sequence
    // (TOKEN)
    // in the exception message. A "for" implementation needs then to scan
    // the
    // message for this token.
    // While this implementation is also not bullet proof, it appears to be
    // more
