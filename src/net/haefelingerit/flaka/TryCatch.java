 ...
 * 
 * <li>If the property attribute has been set, a property of the given name
 * will be set to the message of the exception.</li>
 * 
 * <li>If the reference attribute has been set, a reference of the given id
 * will be created and point to the exception object.</li>
 * 
 * <li>If there is a <code>&lt;catch&gt;</code> block, the tasks nested into
 * it will be run.</li>
 * </ul>
 * 
 * <p>
