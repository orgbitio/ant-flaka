...
public class CvsStat extends Task
{
  ...
  public void execute() throws BuildException {
    ...
    if (this.path == null) {
      ...
      if (Static.isEmpty(s)) {
        handleError("use 'path' to specify file argument.");
        return;
      }
  ...
  protected void statCvsProperties() throws BuildException {
    ...
    if (!file.exists()) {
      handleError("this file does not exists: " + file.getPath());
      return;
    }
    ...
    /* find in entries the line that starts with "/<file>/" */
    ...
    /*
     * This file seems to be only present if a folder is checked out with a tag.
